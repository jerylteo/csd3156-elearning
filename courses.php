          ...
          while($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-4">
              ...
              <div class="p-5">
                ...
                <a href="courses.php?course='. htmlspecialchars($row['ID']) .'" class="view-course-btn inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  View Modules
